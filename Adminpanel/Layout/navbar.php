<nav class="dash-nav-list">
                <a href="index.html" class="dash-nav-item">
                    ...
                    <a href="manageshops.php" class="dash-nav-item">
                        <i class="fa fa-building"></i>Shops </a>

                <div class="dash-nav-dropdown">
                    <a href="#!" class="dash-nav-item dash-nav-dropdown-toggle">
                        <i class="fa fa-user"></i>Staff</a>
                    <div class="dash-nav-dropdown-menu">
                        <a href="addstaff.php" class="dash-nav-dropdown-item">Manage</a>
                ...
                <div class="dash-nav-dropdown">
                    ...
                    <div class="dash-nav-dropdown-menu">
                        <a href="manageproducts.php" class="dash-nav-dropdown-item">Manage</a>
                        <a href="dailystock.php" class="dash-nav-dropdown-item">Daily Stock</a>
                        <a href="editstock.php" class="dash-nav-dropdown-item">Delete/Wastage</a>
                ...
                <a href="managecategorie.php" class="dash-nav-item">
                        <i class="fa fa-bars" aria-hidden="true"></i>Categorie </a>

                <a href="managesupplier.php" class="dash-nav-item">
                        <i class="fa fa-user-plus" aria-hidden="true"></i>Supplier </a>
            </nav>
            </div>
        <div class="dash-app">
